...
> **`PIP-2`–`PIP-7` are execution** → `okf/capabilities/pipeline-execution/pipeline-execution.md`
> (planned). *("orchestration" left this heading 2026-09-09 — it is not a glossary term;
