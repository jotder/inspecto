...
> **FROZEN SNAPSHOT — 2026-09-07.** This is `docs/INDEX.md` as it stood before the consolidation that
> reduced it from 879 lines to a curated map. It is kept for provenance only: it holds the full
> per-plan as-built narratives for the 46 archived plans, whose routing (plan → OKF concept) survives in
> the live index as a table. **Never maintained, never linked as current.** The live map is
> [`../INDEX.md`](../INDEX.md).
