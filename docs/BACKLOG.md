...
| State | P2 rows |
|---|---|
| **Startable now** — no gate, no owed decision | Bundle "load as draft" slice 5, authored Pipeline (§3.7) · X1 retry affordance + per-pipeline `processing.retry` (§3.2) · policy-authoring save-time guards F1–F9 (§3.8) · parser plugins P2–P4 (§3.3) |
