...
- **COLLECTOR-ERRMSG-1 (folds into spec §R1's message sweep) — parser error messages still say
  ...
  consolidation (the docs' ghost `source:` section is already corrected —
  `okf/backend/config/configuration.md`). ⚠ Message strings only; do NOT rename any parsed key.
