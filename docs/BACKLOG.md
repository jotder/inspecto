...
| 3.9 | Findings values on a Case | decided 2026-09-25: saving Findings values is open to anyone who can see the Case (collaboration, like comments) — a Findings-only write, being built; disposition PATCH stays `canAdminister` |
