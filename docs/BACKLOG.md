...
| State | P2 rows |
|---|---|
| **Startable now** — no gate, no owed decision | assurance wave 2, in order once wave 1 lands: `ASSURE-MAKER-CHECKER-1` (§3.7) → `ASSURE-ENTITY-LISTS-1` (§3.5) → `ASSURE-ACTION-REQUESTS-1` (§3.5) |
