...
**Verdict counts:** UNBLOCKED **37** · BLOCKED-OPERATOR **8** · DESIGN-FIRST **8** *(7 + `GRAPH-LANE-RULE-ROUTED-1`; `GRAPH-LANE-MULTISCHEMA-1` was filed, designed, decided and SHIPPED on 2026-09-16 and is off the board)* · BLOCKED-EXTERNAL (trigger not
