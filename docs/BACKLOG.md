...
| State | P2 rows |
|---|---|
| **Startable now** — no gate, no owed decision | X4 replay residuals — a replay button on Run Detail, the crash-mid-replay claim, auditing the actor (§3.2) · AI drafting for `transform` (§3.1, every call answered 2026-09-25) · Bundle "load as draft" (§3.7, every call answered 2026-09-25) |
