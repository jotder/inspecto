...
| 34 | D8 notification residuals | ✅ APPROVED TO BUILD 2026-09-15. **Soft-bounce retry ONLY**; the SES/SNS adapter stays filed with its own review | Notifications (§3) · `D8-SUPPRESS-1` (§3) |
