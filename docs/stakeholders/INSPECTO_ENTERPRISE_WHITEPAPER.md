...
| Extension | bespoke code at every seam | **20**<!--count:spi-extension-points--> **extension points** plus a services model |
...
**Lane 2 — the 20**<!--count:spi-extension-points--> **extension points.** Every seam where estates differ is a
