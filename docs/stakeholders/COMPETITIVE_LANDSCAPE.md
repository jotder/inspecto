...
**22**<!--count:spi-extension-points--> extension-point interfaces, derived by `tools/check-doc-counts.mjs`
...
| **22**<!--count:spi-extension-points--> extension points; the ASN.1 vendor functions ship through one | §1.4; guard-derived |
