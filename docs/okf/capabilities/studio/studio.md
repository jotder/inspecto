...
The board rows were `docs/REQUIREMENTS.md` §3.5 (that section was stripped to an index on 2026-09-09 — this file is their only home now) `BI-1`…`BI-8` and §3.6 `INV-1`…`INV-4`, plus
