...
# Architecture & Design
> **Deep reference — the detail tier.** Start at [Engine section index](index.md) for the summary; this page is the long form it points to. *(Moved from the retired root-level `architecture.md` (docs consolidation, 2026-07-16).)*
