...
| SEC-09 | Actor-attributed, tamper-evident audit log | 🟡 | ✅ | ✅ | P has no actor (auth-free) — events carry the default actor **`appUser`** (`ApiContext.actor`; corrected 2026-09-08 — no `anonymous` string exists) |
