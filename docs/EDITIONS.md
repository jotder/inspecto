...
| SP-SNK-03 | 🦆 DuckLake catalog (PostgreSQL) sink (`sink.ducklake`) | Sinks, Storage & Destinations | ✅ | ✅ | ✅ | `sink.persistent` | `output.ducklake` — needs the postgresql sidecar (Professional+) |
