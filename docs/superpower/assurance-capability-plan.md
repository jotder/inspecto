...
| 1.2 | **WS-11 finish** — `assigned` state, `lastSeenAt`, `occurrences`, ageing and recurrence computed server-side | 0.5–1 | Small; closes a shipped feature properly | a recurring Break counts up across runs; ageing shows on the Recon Board |
