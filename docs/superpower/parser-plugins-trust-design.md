...
> **State, 2026-09-25: slice P1 (the T1 trust gate) SHIPPED. P0 is half done (its staged-bytes fix is
> `f90ddcf25`; the server-owned staging dir is still open). P2–P5 and C1–C4 are not built.** Operator
> decisions 2026-09-25: D1 = fifth Job Pack kind, D2 = T1 required (T2 not built), D3 = refuse,
> D4 = the Pipeline-authoring capability for pack parsers only, D7 = no edition gate, D8 = defer.
> D5/D6/D9/D10 are still owed. As-built facts are in the owner concept's *Drop-in parser jars* section.
>
