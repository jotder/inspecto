...
> **State, 2026-09-25: slices P1 (the T1 trust gate) and P2 (pack parser registration) SHIPPED. P0 is
> half done (its staged-bytes fix is `f90ddcf25`; the server-owned staging dir is still open). P3–P5 and
> C1–C4 are not built.** Operator decisions 2026-09-25 (all ten answered): D1 = fifth Job Pack kind, D2 = T1
