...
| **LA-08** | `POST /inv/projection/multi` | ⬜ **UNBLOCKED 2026-09-23** | M | — (D-S4 decided: normalise + warn) | Node mappings + edge projections across Datasets in one call; unified DuckDB union views; `__provenance_dataset` tagging. Contract §5.2. |
