...
- [`okf/`](okf/index.md) — master index. Four parts:
...
| [`edg-01-edition-gating-plan.md`](superpower/edg-01-edition-gating-plan.md) | IN FLIGHT | EDG-01: gating the six "not for Personal" features. **Five cells SHIPPED 2026-09-07** (CP-15 · OPS-06 · CP-09 · SEC-10 · CP-13's metrics half); as-built recipe distilled to [editions model](okf/backend/editions/editions-model.md). Still in flight for the last two — CP-13's events feed and CP-11 — which are **blocked on an operator call on scope** (§§18–19). |
