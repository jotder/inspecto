...
| [`edg-01-edition-gating-plan.md`](superpower/edg-01-edition-gating-plan.md) | IN FLIGHT | EDG-01: gating the six "not for Personal" features. Mechanism decided (ServiceLoader modules); census done and ranked; no cell built yet. |
