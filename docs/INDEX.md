...
| [`duckle-concepts-candidates.md`](superpower/duckle-concepts-candidates.md) | **TRIAGED 2026-09-15 — §2 reviewed in full, §1 decided; ONE ruling open (C7)** | Ten main + fifteen smaller operational rules distilled from slothflowlabs/duckle. **§2 (the fifteen) was reviewed in full on 2026-09-15** — every "check ours" note now carries a grounded verdict: 1 closed by building it (S15 cron DST tests), 3 already satisfied (S7/S8/S14), **6 defects found and filed**, 6 feature gaps ranked. **§1 (the ten) was decided 2026-09-15**: C1/C2/C3/C4/C6/C8/C9/C10 **adopted** as `DUCKLE-*` §3 rows, C5 struck as design reference, **C7 awaiting one ruling** (does the git-integration exclusion cover a CI-shaped affected/contracts check?). ⚠ **Do not archive until C7 is ruled.** Out of scope by operator decision: git integration, component count, UI languages. |
