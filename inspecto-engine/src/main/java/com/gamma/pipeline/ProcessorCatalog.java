...
public final class ProcessorCatalog {
    ...
    public static final List<Processor> PROCESSORS = List.of(
            ...
            p("ENR", "ml.llm.classify", "🏷️", "heroicons_outline:sparkles", "LLM zero-shot classifier & tagging", Status.PLANNED, null, null, "still unbuilt; the assist agent now ships Standard+ (CP-14, `PKG-5` 2026-09-12) but this step kind does not exist"),
