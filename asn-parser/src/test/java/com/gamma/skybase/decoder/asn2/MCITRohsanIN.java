...
//import java.util.*;
//
//public class MCITRohsanIN {
//
//    static String[] EVENT_LIST = {"RAFVoiceEvent", "RAFDataEvent", "RAFPurchaseEvent", "RAFPolicyChangeEvent", "RAFTextEvent", "RAFCancelEvent", "RAFUserDeleteEvent",
//            "RAFSubscriptionDeleteEvent", "RAFDeviceDeleteEvent", "RAFBalanceAdjustEvent", "RAFRecurringEvent", "RAFBalanceThresholdEvent",
//            "RAFPurchasedItemCycleChangeEvent", "RAFUserModifyEvent"};
...
//            "RAFVoiceEvent", "RAFDataEvent", "RAFPurchaseEvent", "RAFPolicyChangeEvent", "RAFTextEvent",
//            "RAFCancelEvent", "RAFUserDeleteEvent", "RAFSubscriptionDeleteEvent", "RAFDeviceDeleteEvent",
//            "RAFBalanceAdjustEvent", "RAFRecurringEvent", "RAFBalanceThresholdEvent",
//            "RAFPurchasedItemCycleChangeEvent", "RAFUserModifyEvent"
//    ));
//
//    public static void main(String[] args) throws XMLStreamException, IOException {
//
//        String file2Parse = "C:\\projects\\asn-decoders\\generic-asn-reader\\data\\mcit\\roshan\\in\\mef_1686721198_477678577388_477678637706.xml";
//
//        eventFields.put("EVENT_LIST", EVENT_LIST);
//        eventFields.put("CombinedEvent", CombinedEvent);
//        eventFields.put("RAFVoiceEvent", RAFVoiceEvent);
//        eventFields.put("RAFDataEvent", RAFDataEvent);
//        eventFields.put("RAFPurchaseEvent", RAFPurchaseEvent);
//        eventFields.put("RAFPolicyChangeEvent", RAFPolicyChangeEvent);
//        eventFields.put("RAFTextEvent", RAFTextEvent);
//        eventFields.put("RAFCancelEvent", RAFCancelEvent);
//        eventFields.put("RAFUserDeleteEvent", RAFUserDeleteEvent);
//        eventFields.put("RAFSubscriptionDeleteEvent", RAFSubscriptionDeleteEvent);
//        eventFields.put("RAFDeviceDeleteEvent", RAFDeviceDeleteEvent);
//        eventFields.put("RAFBalanceAdjustEvent", RAFBalanceAdjustEvent);
//        eventFields.put("RAFRecurringEvent", RAFRecurringEvent);
//        eventFields.put("RAFBalanceThresholdEvent", RAFBalanceThresholdEvent);
//        eventFields.put("RAFPurchasedItemCycleChangeEvent", RAFPurchasedItemCycleChangeEvent);
...
//                    if (startElement.endsWith("List") || startElement.endsWith("Array"))
