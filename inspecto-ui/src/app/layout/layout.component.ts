...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this._gammaConfigService.config$.pipe(takeUntil(this._unsubscribeAll)).subscribe((config: GammaConfig) => {
            // Store the config
            this.config = config;
        ...
        // Set the OS name
        this._renderer2.addClass(this._document.body, this._gammaPlatformService.osName);
    }
