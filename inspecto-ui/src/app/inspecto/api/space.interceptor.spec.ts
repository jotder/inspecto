...
describe('spaceInterceptor', () => {
    describe('with an active space', () => {
        ...
        it('ignores non-API URLs (static assets)', () =>
            expectUrl('./assets/icons/heroicons-outline.svg', './assets/icons/heroicons-outline.svg'));
        ...
        it('leaves /v1/bootstrap server-global', () => expectUrl(`${base}/v1/bootstrap`, `${base}/v1/bootstrap`));
