...
export const MOCK_STORE_KEY = 'inspecto.mock.v24'; // v24: a route: pipeline (cdr_route_demo) so the per-Step switch is exercisable offline (v23: cdr_ingest parsing: block)
