 ...
 * BUILDER/power to admin and `canCurateMenus` was split out of `canAuthorWorkbench` to admin/power
 * 2026-07-25 (BACKLOG D14/D4) — keep this table in step with `Roles.seed()`.
 */
