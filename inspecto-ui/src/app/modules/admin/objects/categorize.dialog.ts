    ...
    <mat-dialog-content class="flex flex-col gap-3 pt-2">
      ...
      <form [formGroup]="form" class="flex flex-col gap-3">
        <mat-form-field subscriptSizing="dynamic">
          ...
          @if (
            form.controls.l1.hasError("required") && form.controls.l1.touched
          ) {
        ...
        <mat-form-field subscriptSizing="dynamic">
          ...
          @if (
            form.controls.l2.hasError("required") && form.controls.l2.touched
          ) {
        ...
        <mat-form-field subscriptSizing="dynamic">
          ...
          @if (
            form.controls.l3.hasError("required") && form.controls.l3.touched
          ) {
  ...
  constructor() {
    ...
    if (l1 && INCIDENT_TAXONOMY[l1]) {
      ...
      if (l2 && INCIDENT_TAXONOMY[l1][l2]) {
        ...
        if (l3 && INCIDENT_TAXONOMY[l1][l2].includes(l3))
