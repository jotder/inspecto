...
export const GLYPH_LIBRARY: Record<string, string> = {
    ...
    cylinder:
        '<path d="M12 3c3.9 0 7 1.3 7 3s-3.1 3-7 3-7-1.3-7-3 3.1-3 7-3z"/><path d="M5 6v12c0 1.7 3.1 3 7 3s7-1.3 7-3V6"/>',
    ...
    database:
        '<path d="M12 3c3.9 0 7 1.1 7 2.5S15.9 8 12 8 5 6.9 5 5.5 8.1 3 12 3z"/><path d="M5 5.5v13C5 19.9 8.1 21 12 21s7-1.1 7-2.5v-13"/>',
...
const KIND_GLYPH: Record<string, string> = {
    ...
    TABLE: 'cylinder',
    DERIVED_TABLE: 'transform',
    REFERENCE_DATASET: 'database',
    KPI: 'bell',
    REPORT: 'report',
    COLUMN: 'columns',
};
