                            ...
                            of([
                                {
                                    ...
                                    type: 'maintenance',
                                    trigger: 'schedule',
                                    startTime: '2026-07-12 03:00:00',
                                    endTime: '2026-07-12 03:00:01',
                                    status: 'FAILED',
                                    durationMs: 10,
                                    message: 'disk full',
                                },
                                {
                                    ...
                                    type: 'pipeline',
                                    trigger: 'schedule',
                                    startTime: '2026-07-12 03:05:00',
                                    endTime: '2026-07-12 03:05:01',
                                    status: 'FAILED',
                                    durationMs: 10,
                                    message: 'not maintenance — excluded',
                                },
                            ]),
                        latestArtifacts: () =>
                            of([
                                {
                                    ...
                                    name: 'backup',
                                    kind: 'file',
                                    ref: 'backups/demo_config_20260712.zip',
                                    rows: 0,
                                    bytes: 2048,
                                    at: '',
                                },
