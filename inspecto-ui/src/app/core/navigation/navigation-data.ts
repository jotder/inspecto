...
export const defaultNavigation: GammaNavigationItem[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { id: 'tags', title: 'Tags', type: 'basic', icon: 'heroicons_outline:tag', link: '/tags' },
        ],
    },
    {
        id: 'platform-group',
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        id: 'studio-dashboards',
                        title: 'Dashboard Builder',
                        type: 'basic',
                        icon: 'heroicons_outline:squares-2x2',
                        link: '/studio/dashboards',
                    },
                    {
                        id: 'studio-templates',
                    ...
                    {
                        id: 'studio-link-analysis',
                        title: 'Link Analysis',
                        type: 'basic',
                        icon: 'heroicons_outline:share',
                        link: '/studio/link-analysis',
                    },
                    {
                        id: 'menus',
                        title: 'Menus',
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        id: 'catalog-onboard',
                        title: 'Onboard Stream',
                        type: 'basic',
                        icon: 'heroicons_outline:plus-circle',
                        link: '/catalog',
                        queryParams: { onboard: 'stream' },
                    },
                    {
                        id: 'studio-datasets',
                        title: 'Datasets',
