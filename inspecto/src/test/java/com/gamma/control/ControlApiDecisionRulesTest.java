 ...
 *
 * <p>⚠ The three {@code apply} cases that read promoted Incidents back through {@code GET /objects} stayed
 * in {@code inspecto-ops} as {@code ControlApiDecisionRuleApplyTest} — that route does not exist without it
 * (EDITION-GATED-TESTS-IN-WRONG-HOME-1). Everything here is object-free and runs in the default reactor.
 */
