...
public final class ConsignmentAuditWriter {
    ...
    public ConsignmentAuditWriter(String statusPath, String batchesPath, String lineagePath,
        ...
        this.lineage = lineagePath == null ? null : new CsvLedger<>(lineagePath,
                ...
                ConsignmentAuditWriter::lineageLine);
     ...
     * each terminal batch. The composition root wires this to {@code PipelineConsignmentSignal::emit}; a
     ...
     */
    public void setTerminalBatchSink(Consumer<ConsignmentEvent> sink) {
    ...
    public synchronized void flush(ConsignmentRow batch, List<FileRow> files, List<LineageRow> lineageRows) {
        ...
        // never row content.
        //  - commitListener   : the service's ConsignmentEventBus sink (enrichment triggers, ...).
        //  - terminalBatchSink : emits the canonical pipeline.batch.committed|failed Signal onto the
        //    ledger, wired by the composition root to PipelineConsignmentSignal::emit. Keeping the Signal
