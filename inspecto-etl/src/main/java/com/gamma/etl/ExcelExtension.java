 ...
 *
 * <p>The loading modes (staged: ONLY the file under {@code -Dduckdb.extension.dir}, missing = loud failure;
 * unstaged: cached {@code LOAD} → a networked {@code INSTALL}) live in {@link DuckDbExtension}, which
 * {@link DuckLakeRegistrar} shares.
 ...
 *
 * <p>If loading fails, the batch fails with a message naming every remedy — never a silent or
