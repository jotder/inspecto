...
| DELETE | `/notifications/(?!suppressions$)([^/]+)` | gated | `canAdminister` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:79` |
| POST | `/notifications/([^/]+)/read` | exempt | self-service | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:46` |
| POST | `/notifications/([^/]+)/unread` | exempt | self-service | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:47` |
| POST | `/notifications/channels` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:57` |
| DELETE | `/notifications/channels/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:61` |
| PUT | `/notifications/channels/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:59` |
| PUT | `/notifications/preferences` | gated | `canAdminister` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:52` |
| POST | `/notifications/read-all` | exempt | self-service | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:45` |
| POST | `/notifications/rules` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:66` |
| DELETE | `/notifications/rules/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:70` |
