...
| POST | `/inv/projection` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:87` |
| POST | `/inv/projection/multi` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:89` |
| POST | `/inv/projection/neighbors` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:88` |
| POST | `/inv/schema/overlap-profile` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:91` |
| POST | `/inv/snapshots` | gated | `canManageIncidents` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:101` |
| POST | `/inv/snapshots/attach` | gated | `canManageIncidents` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:104` |
...
| PUT | `/pipelines/([^/]+)/graph` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/PipelineGraphRoutes.java:81` |
...
| POST | `/pipelines/authored/([^/]+)/dry-run` | exempt | read-shaped | `inspecto/src/main/java/com/gamma/control/PipelineGraphRoutes.java:65` |
| POST | `/pipelines/authored/([^/]+)/run` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/PipelineGraphRoutes.java:69` |
| POST | `/pipelines/authored/([^/]+)/trigger` | gated | `canOperateRuns` | `inspecto/src/main/java/com/gamma/control/PipelineGraphRoutes.java:74` |
