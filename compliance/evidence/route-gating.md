...
| POST | `/cases/from-entities` | gated | `canManageIncidents` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:109` |
| POST | `/cases/rules` | gated | `canAuthorWorkbench` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:102` |
| DELETE | `/cases/rules/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:103` |
| POST | `/cases/rules/([^/]+)/evaluate` | gated | `canAdminister` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:104` |
| POST | `/collectors/([^/]+)/notify` | gated | `canOperateRuns` | `inspecto/src/main/java/com/gamma/control/AcquisitionRoutes.java:28` |
| POST | `/components/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/ComponentRoutes.java:49` |
| DELETE | `/components/([^/]+)/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/ComponentRoutes.java:51` |
| PUT | `/components/([^/]+)/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/ComponentRoutes.java:50` |
| POST | `/components/([^/]+)/([^/]+)/versions/([^/]+)/restore` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/ComponentRoutes.java:54` |
| POST | `/components/grammar/([^/]+)/test` | exempt | read-shaped | `inspecto/src/main/java/com/gamma/control/ComponentRoutes.java:58` |
| POST | `/components/grammar/preview` | exempt | read-shaped | `inspecto/src/main/java/com/gamma/control/ComponentRoutes.java:65` |
...
| POST | `/dashboards/([^/]+)/share` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/ShareRoutes.java:47` |
...
| POST | `/inv/investigations` | gated | `canManageIncidents` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvestigationRoutes.java:124` |
...
| POST | `/inv/investigations/([^/]+)/ops` | gated | `canManageIncidents` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvestigationRoutes.java:126` |
| POST | `/inv/investigations/([^/]+)/pending/([^/]+)/approve` | gated | `canApproveLinkExpansions` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvestigationRoutes.java:136` |
| POST | `/inv/investigations/([^/]+)/pending/([^/]+)/deny` | gated | `canApproveLinkExpansions` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvestigationRoutes.java:138` |
| POST | `/inv/investigations/([^/]+)/reorder` | gated | `canManageIncidents` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvestigationRoutes.java:130` |
| POST | `/inv/investigations/([^/]+)/replay` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvestigationRoutes.java:132` |
| POST | `/inv/investigations/([^/]+)/reveal` | gated | `canRevealLinkEntities` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvestigationRoutes.java:134` |
...
| POST | `/inv/investigations/([^/]+)/undo` | gated | `canManageIncidents` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvestigationRoutes.java:128` |
| POST | `/inv/pattern/branching` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/PatternRoutes.java:59` |
| POST | `/inv/projection` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:98` |
| POST | `/inv/projection/multi` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:100` |
| POST | `/inv/projection/neighbors` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:99` |
| POST | `/inv/schema/overlap-profile` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:102` |
| POST | `/inv/snapshots` | gated | `canManageIncidents` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:113` |
| POST | `/inv/snapshots/attach` | gated | `canManageIncidents` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:116` |
| POST | `/inv/traversal/recursive-paths` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:103` |
...
| DELETE | `/notifications/(?!suppressions$)([^/]+)` | gated | `canAdminister` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:77` |
| POST | `/notifications/([^/]+)/read` | gated | `canAdminister` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:45` |
| POST | `/notifications/channels` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:55` |
| DELETE | `/notifications/channels/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:59` |
| PUT | `/notifications/channels/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:57` |
| PUT | `/notifications/preferences` | gated | `canAdminister` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:50` |
| POST | `/notifications/read-all` | gated | `canAdminister` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:43` |
| POST | `/notifications/rules` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:64` |
| DELETE | `/notifications/rules/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:68` |
| PUT | `/notifications/rules/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto/src/main/java/com/gamma/control/NotificationRoutes.java:66` |
...
| POST | `/objects` | gated | `canManageIncidents` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:56` |
| PATCH | `/objects/([^/]+)` | gated | `canAdminister` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:87` |
| POST | `/objects/([^/]+)/ack` | gated | `canAdminister` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:72` |
| POST | `/objects/([^/]+)/assign` | gated | `canAdminister` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:75` |
| POST | `/objects/([^/]+)/attachments` | exempt | collaboration | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:84` |
| POST | `/objects/([^/]+)/comments` | exempt | collaboration | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:82` |
| DELETE | `/objects/([^/]+)/links` | exempt | collaboration | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:78` |
| POST | `/objects/([^/]+)/links` | exempt | collaboration | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:76` |
| POST | `/objects/([^/]+)/merge` | gated | `canAdminister` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:79` |
| POST | `/objects/([^/]+)/rca` | exempt | collaboration | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:86` |
...
| POST | `/recon/breaks` | exempt | read-shaped | `inspecto/src/main/java/com/gamma/control/ReconRoutes.java:48` |
| POST | `/recon/columns` | exempt | read-shaped | `inspecto/src/main/java/com/gamma/control/ReconRoutes.java:46` |
| POST | `/recon/promote` | gated | `canManageIncidents` | `inspecto/src/main/java/com/gamma/control/ReconRoutes.java:55` |
| POST | `/recon/rows` | exempt | read-shaped | `inspecto/src/main/java/com/gamma/control/ReconRoutes.java:51` |
| POST | `/recon/run` | exempt | stateless-compute | `inspecto/src/main/java/com/gamma/control/ReconRoutes.java:47` |
