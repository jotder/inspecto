...
| POST | `/recon/breaks` | exempt | read-shaped | `inspecto/src/main/java/com/gamma/control/ReconRoutes.java:57` |
| POST | `/recon/columns` | exempt | read-shaped | `inspecto/src/main/java/com/gamma/control/ReconRoutes.java:55` |
| POST | `/recon/promote` | gated | `canManageIncidents` | `inspecto/src/main/java/com/gamma/control/ReconRoutes.java:64` |
| POST | `/recon/rows` | exempt | read-shaped | `inspecto/src/main/java/com/gamma/control/ReconRoutes.java:60` |
| POST | `/recon/run` | exempt | stateless-compute | `inspecto/src/main/java/com/gamma/control/ReconRoutes.java:56` |
