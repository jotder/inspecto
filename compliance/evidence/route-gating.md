...
| POST | `/inv/schema/overlap-profile` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:100` |
| POST | `/inv/snapshots` | gated | `canManageIncidents` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:111` |
| POST | `/inv/snapshots/attach` | gated | `canManageIncidents` | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:114` |
| POST | `/inv/traversal/recursive-paths` | exempt | read-shaped | `inspecto-geo-link/src/main/java/com/gamma/geolink/InvRoutes.java:101` |
