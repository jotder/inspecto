...
| POST | `/cases/from-entities` | gated | `canManageIncidents` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:128` |
| POST | `/cases/rules` | gated | `canAuthorWorkbench` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:121` |
| DELETE | `/cases/rules/([^/]+)` | gated | `canAuthorWorkbench` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:122` |
| POST | `/cases/rules/([^/]+)/evaluate` | gated | `canAdminister` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:123` |
...
| PATCH | `/objects/([^/]+)` | gated | `canAdminister` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:104` |
| POST | `/objects/([^/]+)/ack` | gated | `canWorkIncidents` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:78` |
| POST | `/objects/([^/]+)/assign` | gated | `canWorkIncidents` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:81` |
| POST | `/objects/([^/]+)/attachments` | exempt | collaboration | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:90` |
| PUT | `/objects/([^/]+)/category` | gated | `canWorkIncidents` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:103` |
| POST | `/objects/([^/]+)/comments` | exempt | collaboration | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:88` |
| PUT | `/objects/([^/]+)/findings` | exempt | collaboration | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:97` |
| DELETE | `/objects/([^/]+)/links` | exempt | collaboration | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:84` |
| POST | `/objects/([^/]+)/links` | exempt | collaboration | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:82` |
| POST | `/objects/([^/]+)/merge` | gated | `canAdminister` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:85` |
| PUT | `/objects/([^/]+)/postmortem` | gated | `canWorkIncidents` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:102` |
| POST | `/objects/([^/]+)/rca` | exempt | collaboration | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:92` |
| POST | `/objects/([^/]+)/resolve` | gated | `canWorkIncidents` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:79` |
| POST | `/objects/([^/]+)/split` | gated | `canAdminister` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:86` |
| POST | `/objects/([^/]+)/transition` | gated | `canWorkIncidents` | `inspecto-ops/src/main/java/com/gamma/opsapi/ObjectRoutes.java:80` |
